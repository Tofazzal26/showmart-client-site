            ...
            <div className="container p-4 mx-auto space-y-16 sm:p-10">
              <div className="space-y-4">
                ...
                <p className="max-w-2xl dark:text-gray-600">
                  A group of dedicated professionals, including Oliver Bennett,
                  Sophia Carter, Ethan Turner, and Ava Mitchell, who bring
                  expertise, passion, and innovation to every project. Together,
                  they ensure seamless operations, exceptional product design,
              ...
              <div className="grid w-full grid-cols-1 gap-x-6 gap-y-12 sm:grid-cols-2 lg:grid-cols-4">
                <div className="space-y-4">
                  ...
                  <div className="flex flex-col items-center">
                    <h4 className="text-xl font-semibold">Sophia Carter</h4>
                ...
                <div className="space-y-4">
                  ...
                  />
                  <div className="flex flex-col items-center">
                    <h4 className="text-xl font-semibold">Ethan Turner</h4>
                    <p className="text-sm dark:text-gray-600">
                      Product Marketer
                    </p>
                    <div className="flex mt-2 space-x-2">
                ...
                <div className="space-y-4">
                  ...
                  />
                  <div className="flex flex-col items-center">
                    <h4 className="text-xl font-semibold">Oliver Bennett</h4>
                    <p className="text-sm dark:text-gray-600">
                      Product Manager
                    </p>
                    <div className="flex mt-2 space-x-2">
                ...
                <div className="space-y-4">
                  ...
                  />
                  <div className="flex flex-col items-center">
                    <h4 className="text-xl font-semibold">Ava Mitchell</h4>
                    <p className="text-sm dark:text-gray-600">Help Supporter</p>
                    <div className="flex mt-2 space-x-2">
                      <a
                        rel="noopener noreferrer"
                        href="#"
