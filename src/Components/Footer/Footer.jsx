        ...
        <footer className="footer container mx-auto">
          <aside>
            ...
            <p className="text-base lg:w-[600px]">
              ...
              <br />
              ShowMart is a sleek MERN stack app for browsing products with
              ease. It offers pagination, search, categorization, and sorting
              features, all within a responsive, user-friendly interface. Secure
